...
<div class="container">
    ...
    <div class="mint-color fw-bold home-slogan text-center mt-const inner-container">
        ...
        We see the fundamentals of LIFE - love, intimacy, fun and energy. <br>
        Yet while we live and grow, it could be full of challenges,<br>
    ...
    <div class="mt-const inner-container text-justify">As an emotions guide, we facilitate clients to identify feelings
        ...
        <div class="row">
            ...
            <div class="col-5"><img class="w-100" src="http://104.131.45.33/wp-content/uploads/2021/04/water-1.png"
                    alt=""></div>
            <div class="col-7">Negative emotions are like a glass of water with some mud inside. We just want to spoon
