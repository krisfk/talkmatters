...
<div class="container">
    ...
    <div class="inner-container"> We see the fundamentals of LIFE - love, intimacy, fun and energy.
    ...
    <div class="mt-const inner-container text-justify">As an emotions guide, we facilitate clients to identify feelings
        ...
        <div class="row mt-const">
            ...
            <div class="col-9">
                ...
                <div class="mint-bg p-3" style="margin: 68px 0 0 0px;background: rgb(207 228 216 / 85%);">
